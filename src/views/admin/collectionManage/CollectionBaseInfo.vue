  ...
  <div class="search">
    ...
    <div style="margin-bottom: 15px">
      ...
      <el-button
        ...
        type="success"
        @click="$router.push('/recentCollectionInfo')"
        >返回</el-button
      >
    </div>
    <!--表格-->
...
export default {
  ...
  methods: {
    load() {
      request
        .get("/collection/collectionBaseInfo", {
          params: this.params,
        })
        .then((res) => {
          if (res.code === "A0000") {
            this.tableData = res.data.collectionBaseInfo;
    ...
    fuzzyQuery() {
      request
        .get("/collection/collectionBaseInfoFuzzy", {
          params: this.params,
        })
        .then((res) => {
          if (res.code === "A0000") {
            this.tableData = res.data.collectionBaseInfoFuzzy;
            this.total = res.data.total;
          } else if (res.code === "A0004") {
            this.$notify.error("服务器异常！");
          }
